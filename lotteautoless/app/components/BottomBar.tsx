...
const BottomBar = () => {
    ...
    return <div className="fixed z-50 bottom-0 border-t border-[#EFF0F0] left-1/2 rounded-t-3xl transform -translate-x-1/2 w-[420px] mx-auto h-[81px] bg-white pt-[12px] pb-[20px] pr-[80px] pl-[80px]">
        <div className="flex justify-between">
            ...
            <button ><Image src={isMeet ? MeetActive : Meet} alt="Meet" width={44} height={49} /></button>
        </div>
